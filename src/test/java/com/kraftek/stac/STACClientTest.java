package com.kraftek.stac;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.databind.ObjectWriter;
import com.fasterxml.jackson.datatype.jsr310.JavaTimeModule;
import com.kraftek.stac.core.STACClient;
...
public class STACClientTest {
    private STACParser parser;
    private STACClient client;
    private ObjectMapper mapper;

    @Before
    public void setUp() throws Exception {
        parser = new STACParser();
        client = new STACClient("https://earth-search.aws.element84.com/v1", null);
    ...
    private static String readCollections() throws IOException {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(STACClientTest.class.getResourceAsStream("collections.json")))) {
            return reader.lines().collect(Collectors.joining("\n"));
        }
    }

    private static String readItems() throws IOException {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(STACClientTest.class.getResourceAsStream("items_1.json")))) {
            return reader.lines().collect(Collectors.joining("\n"));
        }
    }
}
